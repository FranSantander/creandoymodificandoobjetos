...
//Método prototype para mostrar todos los datos del paciente
Consultorio.prototype.getNombre = function (buscarNombre){
     const result = this._nombrePaciente.filter(element =>{
        if(element._nombrePaciente == buscarNombre){
            console.log(`El nombre del paciente es: ${element._nombrePaciente} y su rut es: ${element._rut}`)
        }
    })
}
...
var p6 = new Paciente("push Henry", 10, "23.333.333-3", "asma")
...
console.log(consultorio1.getNombre("Francisca"))
